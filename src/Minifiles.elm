...
view model =
    div []
        [ fromCenterTop -200
            164
            [ minifile 0 0 True (93 - model.scroll // 2)
              -- -13
            , minifile 0 1 True (93 - model.scroll // 3)
              -- 93
            , minifile 0 2 False (-13 - model.scroll // 2)
              -- 33
            , minifile 0 3 False (-93 - model.scroll // 4)
              -- 13
            , minifile 0 4 True (-73 - model.scroll // 3)
              -- 73
            , minifile 0 5 False (-33 - model.scroll // 4)
              -- -33
            , minifile 0 6 False (-113 - model.scroll // 4)
              -- -33
            ]
        , fromCenterTop -233
            1441
            [ minifileAlt 0 0 True (313 - model.scroll // 4)
              -- -13
            , minifileAlt 0 1 True (393 - model.scroll // 3)
              -- 93
            , minifileAlt 0 2 False (333 - model.scroll // 3)
              -- 33
            , minifileAlt 0 3 False (313 - model.scroll // 4)
              -- 13
            , minifileAlt 0 4 True (373 - model.scroll // 3)
              -- 73
            , minifileAlt 0 5 False (300 - model.scroll // 4)
              -- -33
            , minifileAlt 0 6 False (253 - model.scroll // 4)
              -- -33
            ]
        ]
...
minifile v i alt top =
    svg
        ...
        , g
            [ Svg.Attributes.clipPath ("url(#miniclip-" ++ (toString i) ++ ")")
            , fill "none"
            , fillRule "evenodd"
            , stroke "#1C2C3F"
            , strokeWidth "4"
            ...
            [ g
                [ transform ("translate(20, " ++ (toString (100 - top)) ++ ")")
                ]
...
minifileAlt v i alt top =
    svg
        ...
        , g
            [ Svg.Attributes.clipPath ("url(#miniclipalt-" ++ (toString i) ++ ")")
            , fill "none"
            , fillRule "evenodd"
            , stroke "#1C2C3F"
            , strokeWidth "4"
            ...
            [ g
                [ transform ("translate(0, " ++ (toString (-50 - top)) ++ ")")
                ]
