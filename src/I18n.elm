...
keywordsMaster = translate
  { fr = "Masters"
  , en = "Masters"
  }

keywordsMasterVersion = translate
  { fr = "Gestion de version"
  , en = "Version management"
  }

keywordsMasterArchive = translate
  { fr = "Archivage"
  , en = "Archiving"
  }

keywordsLabo = translate
  { fr = "Labo en Ligne"
  , en = "Online Lab"
  }

keywordsLaboQc = translate
  { fr = "Contrôle qualité"
  , en = "Quality check"
  }

keywordsLaboDelivery = translate
  { fr = "Livrables domestiques & internationaux"
  , en = "Domestic & international delivery"
  }

keywordsDiffusion = translate
  { fr = "Diffusion"
  , en = "Diffusion"
  }

keywordsDiffusion2 = translate
  { fr = "& Monétisation"
  , en = "& Monetization"
  }

keywordsDiffusionCert = translate
  { fr = "Diffusion & Livrables certifiés"
  , en = "Certified broadcast & delivery"
  }

keywordsDiffusionOnDemand = translate
